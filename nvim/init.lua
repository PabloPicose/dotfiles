...
vim.keymap.set('n', '<leader>ch', '<cmd>LspClangdSwitchSourceHeader<CR>', { desc = '[C]ode switch [H]eader/source' })
-- [[ Basic Autocommands ]]
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = function()
      -- Runs after :Lazy sync / first install on a new machine
